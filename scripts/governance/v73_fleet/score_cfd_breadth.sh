...
print(json.dumps({
  ...
  "evidence": ev,
  "failures": fa,
  "honest_note": "regime detection is grep-based · over-counts when identifier appears in comments/docs; matrix_doc cell-count is heuristic and replaceable with structured YAML if V73 needs precision"
