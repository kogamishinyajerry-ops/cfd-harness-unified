...
TRACK-3-rerun (B35) — M-STACK-TRACK-3-rerun. Same substrate as TRACK-3
plus the now-LANDED step_path forwarding (REQ-SCHEMA-EXPAND) and
auto-extracted bc_specs via parts_manifest['parts'][*]['bc'] (D10
sub-DEC). bc_fork pinned to 'main' to match case_006's ESI v2312
Docker target.

Run from repo root:
    .venv/bin/python -m scripts.stack_track_c_session_3_rerun.run_python_path
"""
