...
当前 V-row truth-capture rate:                    **case_004: 5/9 ✓ (clause-1 MET · ≥5/9 阈值过)** · case_006: 3/9 ✓ · 累计 ≥3/9: 2/3 cases (clause-2 需 ≥3 cases · 差 1 个 · 推荐 case_011 / case_016 / case_009 substrate 扩展)
当前 Done dims MET:                               **3 / 6**   (Done #1 distinct numerics 5/5 ✓ B44 + Done #3 D-class 3/3 ✓ B39 + Done #5 carry-over 4/≥4 ✓ B42 · Done #6 clause-1 MET 待 clause-2 cross-case · 仍 Done #2 V-corpus + Done #4 validation reports)
```
