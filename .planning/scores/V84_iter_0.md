...
**Generated**: 2026-05-17T09:15:05Z
...
- `lint`: 1
- `vitest`: 1
- `vitest_passed_count`: 538

**Evidence**:
- typecheck: PASS (tsc --noEmit clean)
- lint: PASS (eslint clean)
- vitest: PASS (538 tests · /tmp/v67c_vitest.log)
...
- `specs_pass_count`: 160
- `specs_total_count`: 161

**Evidence**:
- playwright: 160/161 (59/60 pro-rated by exact pass rate)
- no-blocker: 0 click-intercepted / timeout signals

**Failures**:
- V78 tightened: 160/161 specs PASS · need 100% for FULL
...
- backend HTTP /api/cases probe: PASS (port=57618 · 3853 bytes)
...
- focus management: 72 ARIA/role/tabIndex usages (FULL=20/20)
...
- graceful offline paths: 56 (FULL=20/20)
...
- URL state resumability: 15 sync sites (FULL=25/25)
