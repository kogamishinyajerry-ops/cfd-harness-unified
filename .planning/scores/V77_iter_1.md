# V77 Fleet Score · Iter 1

**Generated**: 2026-05-16T20:03:40Z
**Commit**: `0de5e89b16d1bf11d4e9013930774e3f393977db`
**Total (min one-vote-veto across 16 pillars)**: **54 / 100**
**Weighted sum (informational)**: 128.97
**Verdict**: PROCEED (lift lowest dim)
**Next-iter target dim**: `smoke` (score=54)

## Per-Dim Scores (16 pillars)

| # | Agent | Dim | Score | Weight | Status |
|---|---|---|---|---|---|
| 1 | `quality` | 代码质量 | **80** | 0.12 | 🟡 mid |
...
- `specs_pass_count`: 116
- `specs_total_count`: 122

**Evidence**:
- playwright: 116 specs PASS ≥17 threshold (FULL=60/60)
...
- backend HTTP /api/cases probe: PASS (port=63063 · 3853 bytes)
...
- focus management: 53 ARIA/role/tabIndex usages (FULL=20/20)
...
**Evidence**:
- sse_event_stream: 11 hook refs + 1 status testid (FULL=25/25)
