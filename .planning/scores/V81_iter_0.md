...
**Generated**: 2026-05-17T06:20:18Z
...
- `lint`: 1
- `vitest`: 1
- `vitest_passed_count`: 485

**Evidence**:
- typecheck: PASS (tsc --noEmit clean)
- lint: PASS (eslint clean)
- vitest: PASS (485 tests · /tmp/v67c_vitest.log)
...
- `specs_pass_count`: 146
- `specs_total_count`: 147

**Evidence**:
- playwright: 146/147 (59/60 pro-rated by exact pass rate)
- no-blocker: 0 click-intercepted / timeout signals

**Failures**:
- V78 tightened: 146/147 specs PASS · need 100% for FULL
...
- `png_snapshot_count`: 77
- `viewport_mode_specs_pass`: 7

**Evidence**:
- visual baseline: 77 PNG files (FULL=30/30 · V78 raised threshold to 76)
