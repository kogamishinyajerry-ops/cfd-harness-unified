# V74 Fleet Score · Iter 1

**Generated**: 2026-05-16T17:14:06Z  
**Commit**: `6d7816d4e3042cd7070e2f30312ec74a4754fd6b`  
**Total (min one-vote-veto across 13 pillars)**: **100 / 100**  
**Weighted sum (informational)**: 119.00  
...
- `specs_pass_count`: 98
- `specs_total_count`: 98

**Evidence**:
- playwright: 98 specs PASS ≥17 threshold (FULL=60/60)
...
- backend HTTP /api/cases probe: PASS (port=64798 · 3853 bytes)
