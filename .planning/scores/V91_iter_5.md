# V78 Fleet Score · Iter 5 · TIGHTENED scoring

**Generated**: 2026-05-18T06:25:09Z
**Commit**: `0de5e89b16d1bf11d4e9013930774e3f393977db`
**Total (min one-vote-veto across 16 pillars)**: **75 / 100**
**Weighted sum (informational)**: 132.05
**Verdict**: PROCEED (lift lowest dim)
**Next-iter target dim**: `ux` (score=75)
...
**Score**: 75 / 100 · Weight: 0.15

**Subscores**:
- `flow_completion`: 48
- `latency_band`: 12
- `no_blocker_clicks`: 15
- `specs_pass_count`: 124
- `specs_total_count`: 153

**Evidence**:
- playwright: 124/153 (48/60 pro-rated by exact pass rate)
- no-blocker: 0 click-intercepted / timeout signals

**Failures**:
- V78 tightened: 124/153 specs PASS · need 100% for FULL
...
- backend HTTP /api/cases probe: PASS (port=65448 · 3853 bytes)
