# V76 Fleet Score · Iter 4

**Generated**: 2026-05-16T19:39:20Z
**Commit**: `0de5e89b16d1bf11d4e9013930774e3f393977db`
**Total (min one-vote-veto across 15 pillars)**: **87 / 100**
**Weighted sum (informational)**: 129.05
...
- `specs_pass_count`: 111
- `specs_total_count`: 122

**Evidence**:
- playwright: 111 specs PASS ≥17 threshold (FULL=60/60)
...
- backend HTTP /api/cases probe: PASS (port=52442 · 3853 bytes)
