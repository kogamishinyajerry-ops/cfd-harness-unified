...
**Generated**: 2026-05-17T12:11:17Z
...
- `lint`: 1
- `vitest`: 1
- `vitest_passed_count`: 586

**Evidence**:
- typecheck: PASS (tsc --noEmit clean)
- lint: PASS (eslint clean)
- vitest: PASS (586 tests · /tmp/v67c_vitest.log)
...
- backend HTTP /api/cases probe: PASS (port=60332 · 3853 bytes)
...
- focus management: 73 ARIA/role/tabIndex usages (FULL=20/20)
