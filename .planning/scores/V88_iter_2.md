...
**Generated**: 2026-05-17T16:14:03Z
...
- `lint`: 1
- `vitest`: 1
- `vitest_passed_count`: 723

**Evidence**:
- typecheck: PASS (tsc --noEmit clean)
- lint: PASS (eslint clean)
- vitest: PASS (723 tests · /tmp/v67c_vitest.log)
...
- `specs_pass_count`: 177
- `specs_total_count`: 178

**Evidence**:
- playwright: 177/178 (59/60 pro-rated by exact pass rate)
- no-blocker: 0 click-intercepted / timeout signals

**Failures**:
- V78 tightened: 177/178 specs PASS · need 100% for FULL
...
- `png_snapshot_count`: 89
- `viewport_mode_specs_pass`: 7

**Evidence**:
- visual baseline: 89 PNG files (FULL=30/30 · V78 raised threshold to 76)
...
- focus management: 81 ARIA/role/tabIndex usages (FULL=20/20)
...
**Evidence**:
- real-wired surfaces: 82 useQuery/api/SSE refs (FULL=40/40)
