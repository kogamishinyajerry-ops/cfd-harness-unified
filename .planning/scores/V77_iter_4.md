# V77 Fleet Score · Iter 4

**Generated**: 2026-05-16T20:29:28Z
...
- `specs_pass_count`: 130
- `specs_total_count`: 130

**Evidence**:
- playwright: 130 specs PASS ≥17 threshold (FULL=60/60)
...
- `png_snapshot_count`: 76
- `viewport_mode_specs_pass`: 7

**Evidence**:
- visual baseline: 76/30 PNG files (FULL=30/30)
...
- backend HTTP /api/cases probe: PASS (port=49973 · 3853 bytes)
