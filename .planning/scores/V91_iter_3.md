# V78 Fleet Score · Iter 3 · TIGHTENED scoring

**Generated**: 2026-05-18T03:43:23Z
**Commit**: `0de5e89b16d1bf11d4e9013930774e3f393977db`
**Total (min one-vote-veto across 16 pillars)**: **86 / 100**
**Weighted sum (informational)**: 134.90
**Verdict**: PROCEED (lift lowest dim)
**Next-iter target dim**: `ux` (score=86)
...
**Score**: 86 / 100 · Weight: 0.15

**Subscores**:
- `flow_completion`: 59
- `latency_band`: 12
- `no_blocker_clicks`: 15
- `specs_pass_count`: 184
- `specs_total_count`: 185

**Evidence**:
- playwright: 184/185 (59/60 pro-rated by exact pass rate)
- no-blocker: 0 click-intercepted / timeout signals

**Failures**:
- V78 tightened: 184/185 specs PASS · need 100% for FULL
...
**Evidence**:
- real-wired surfaces: 84 useQuery/api/SSE refs (FULL=40/40)
- API endpoints consumed: 12 distinct (FULL=20/20)
