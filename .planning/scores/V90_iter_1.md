# V78 Fleet Score · Iter 1 · TIGHTENED scoring

**Generated**: 2026-05-17T18:24:04Z
**Commit**: `0de5e89b16d1bf11d4e9013930774e3f393977db`
**Total (min one-vote-veto across 16 pillars)**: **70 / 100**
**Weighted sum (informational)**: 134.60
**Verdict**: PROCEED (lift lowest dim)
**Next-iter target dim**: `stability` (score=70)
...
- `lint`: 1
- `vitest`: 1
- `vitest_passed_count`: 774

**Evidence**:
- typecheck: PASS (tsc --noEmit clean)
- lint: PASS (eslint clean)
- vitest: PASS (774 tests · /tmp/v67c_vitest.log)
...
- `specs_pass_count`: 185
- `specs_total_count`: 185

**Evidence**:
- playwright: 185/185 specs PASS · 100% threshold MET (FULL=60/60)
...
- backend HTTP /api/cases probe: PASS (port=63385 · 3853 bytes)
