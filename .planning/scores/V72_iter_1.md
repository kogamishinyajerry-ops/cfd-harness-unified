# V72 Fleet Score · Iter 1

**Generated**: 2026-05-16T15:31:58Z  
**Commit**: `b805198fb8b85acd39a2a31db4f77ede93e2e1c7`  
**Total (min one-vote-veto across 11 pillars)**: **100 / 100**  
**Weighted sum (informational)**: 107.00  
...
- backend HTTP /api/cases probe: PASS (port=54782 · 3853 bytes)
...
- `motion_polish`: 25
- `focus_management`: 25
- `reduced_motion_respect`: 20
- `transition_count`: 12
- `aria_role_count`: 39

**Evidence**:
- keyboard nav: 5/5 PASS (FULL=30/30)
- motion polish: 12 transition usages (FULL=25/25)
- focus management: 39 ARIA/role/tabIndex usages (FULL=25/25)
- reduced-motion: 6 prefers-reduced-motion usages (FULL=20/20)
