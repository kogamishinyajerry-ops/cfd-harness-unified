# V75 Fleet Score · Iter 0

**Generated**: 2026-05-16T17:39:19Z  
**Commit**: `c846ba0aae745feee43a0652bde458889c0999ab`  
**Total (min one-vote-veto across 14 pillars)**: **16 / 100**  
**Weighted sum (informational)**: 119.96  
**Verdict**: PROCEED (multiple dims need attention)  
**Next-iter target dim**: `resumability_observability` (score=16)
...
| 14 | `resumability_observability` | 可恢复性与可观察性 | **16** | 0.06 | 🔴 low |
...
- motion polish: 17 transition usages (FULL=20/20)
- focus management: 49 ARIA/role/tabIndex usages (FULL=20/20)
- reduced-motion: 11 prefers-reduced-motion usages (FULL=15/15)
...
- graceful offline paths: 35 (FULL=20/20)
...
**Score**: 16 / 100 · Weight: 0.06

**Subscores**:
- `error_boundary_coverage`: 0
- `loading_skeleton_coverage`: 0
- `url_state_resumability`: 16
- `observability_indicator`: 0
...
**Evidence**:
- URL state resumability: 2/3 (pro-rated=16/25)

**Failures**:
- 0 error boundaries in v3 (V75.1)
- 0 loading skeletons in v3 (V75.2)
- 0 observability indicators in v3 (V75.4)
