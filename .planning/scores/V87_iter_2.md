...
**Generated**: 2026-05-17T14:43:26Z
...
- `lint`: 1
- `vitest`: 1
- `vitest_passed_count`: 658

**Evidence**:
- typecheck: PASS (tsc --noEmit clean)
- lint: PASS (eslint clean)
- vitest: PASS (658 tests · /tmp/v67c_vitest.log)
...
- `specs_pass_count`: 169
- `specs_total_count`: 169

**Evidence**:
- playwright: 169/169 specs PASS · 100% threshold MET (FULL=60/60)
...
- `png_snapshot_count`: 86
- `viewport_mode_specs_pass`: 7

**Evidence**:
- visual baseline: 86 PNG files (FULL=30/30 · V78 raised threshold to 76)
...
- focus management: 78 ARIA/role/tabIndex usages (FULL=20/20)
...
**Evidence**:
- real-wired surfaces: 78 useQuery/api/SSE refs (FULL=40/40)
