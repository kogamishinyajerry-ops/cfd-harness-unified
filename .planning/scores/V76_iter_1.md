# V76 Fleet Score · Iter 1

**Generated**: 2026-05-16T19:20:12Z
**Commit**: `0de5e89b16d1bf11d4e9013930774e3f393977db`
**Total (min one-vote-veto across 15 pillars)**: **85 / 100**
**Weighted sum (informational)**: 130.10
**Verdict**: PROCEED (lift lowest dim)
**Next-iter target dim**: `visualization_fidelity` (score=85)
...
| 15 | `visualization_fidelity` | 三维可视化保真度 | **85** | 0.06 | 🟡 mid |
...
- backend HTTP /api/cases probe: PASS (port=56297 · 3853 bytes)
...
- graceful offline paths: 45 (FULL=20/20)
...
**Score**: 85 / 100 · Weight: 0.06

**Subscores**:
- `vtk_canvas_mounts`: 15
- `camera_controls`: 20
- `field_legend`: 20
...
**Evidence**:
- vtk canvas mounts: 1/2 (pro-rated=15/30)
