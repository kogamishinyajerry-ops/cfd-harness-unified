# V69 Fleet Score · Iter 0

**Generated**: 2026-05-16T10:52:11Z  
**Commit**: `1dbd05feff2de9361ec09c148028e26ae49bbde8`  
**Total (min one-vote-veto)**: **0 / 100**  
**Weighted sum (informational)**: 85.20  
...
| 2 | `physics` | 物理/数值稳定 | **80** | 0.15 | 🟡 mid |
| 3 | `ux` | 使用手感 | **100** | 0.2 | ✅ PASS-99 |
| 4 | `visualization` | 可视化追踪 | **96** | 0.2 | 🟢 high |
| 5 | `smoke` | 端到端 pipeline | **90** | 0.1 | 🟢 high |
...
**Failures**:
- canonical eval files (individual): 5 (need ≥20 for V69 close · batched B104/B105 do NOT count)
...
**Evidence**:
- playwright: 47 specs PASS ≥11 threshold (FULL=60/60)
...
- `canonical_harness_test_count`: 0
- `frontend_build`: 1
- `typecheck`: 1
- `lint`: 1
...
- backend HTTP /api/cases probe: PASS (port=59489 · 3853 bytes)
...
**Failures**:
- canonical eval harness file missing: ui/backend/tests/test_canonical_advisor_eval.py (V69.2 pending)
...
**Evidence**:
- Done dims MET: 0/7 (from .planning/V69_ARC_GOAL.md)
