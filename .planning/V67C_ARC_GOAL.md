...
- [ ] **V67-C-DONE-1 · TopBar 6-field information density** — case · OF truth · TrustGate · LLM offline · Audit % · AI=advisor (all 6 visible + tested) · evidence: `TopBar.test.tsx` + `e2e/topbar.spec.ts` + visual snapshot
...
- [ ] **V67-C.0 · Bootstrap** (spike-class · this iter) — npm install + fix 3 fleet scripts + write this ARC-GOAL · estimated commit count: 1
- [ ] **V67-C.1 · TopBar 6-field upgrade** — Done dims #1 + #7 · ~120 prod + 80 test
