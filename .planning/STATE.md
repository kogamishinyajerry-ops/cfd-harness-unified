...
status: unknown
last_updated: "2026-04-25T05:00 local"
progress:
  total_phases: 9
  completed_phases: 8
  total_plans: 18
...
pivot:
  ...
  status: "post-pivot-W1-foundation-freeze-DONE · P1-T1+T2+T3+T3b CLEAN CLOSE · P1-T5 task_runner TrustGate integration landed (V61-056 Codex pending) · 663 passed · 4 contracts KEPT · P1-T4 blocked (KOM Draft)"
  go_no_go:
