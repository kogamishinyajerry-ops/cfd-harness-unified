...
### V79 · First D7 injection — `face_orientation` advisor gap surfaced (no detector landed) [backfill 2026-05-12 for case_012 v1 2026-05-09]
...
| Status | `[QUESTIONABLE 2026-05-12]` — claim "no advisor catches D7" verified for advisor-set as of 2026-05-12; future advisor landing would supersede. Verification pending: face_orientation_advisor lands AND ≥ 2 cases exercise it on D7-class defects. case_013 D7 (Phase 2 #1 dispatched · deferred) will be the second injection when sub-session lands |
