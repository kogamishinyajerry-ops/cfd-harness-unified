...
- [x] **M-VAL-REPORT-3** PARTIAL · case_016 m219 cavity DES acoustic · commit `7143ad4` · validation_reports/v63_case_016_m219_cavity_des_acoustic_validation_report.md · Verdict PARTIAL: rhoPimpleFoam + kOmegaSSTIDDES + FW-H functionObject ran · residual 8.5e-8 (solver converged) · 0 sHM mesh errors · case falls short of FULL only because on-disk solver window 17× too short to resolve first Rossiter mode (0.413 ms period) · Heller-Bliss SPL comparison gated by window-too-short (advisor stack predicted gap) · V-row attribution net-new beyond V62-A B29 TRACK-2 retro · 4Q gate offline verified · Done dim #4 PARTIAL-credit 2/3 → 3/3 ✓ MET under user-ratified PARTIAL semantics 2026-05-15
...
当前 Done dims MET:                               **6 / 6 ✓ V63-A CLOSE-READY** (Done #1 ✓ B44 · #2 ✓ B47 · #3 ✓ B39 · #4 ✓ B50 [PARTIAL-credit 3/3 under user-ratified semantics 2026-05-15] · #5 ✓ B42 · #6 ✓ B46 · **PARTIAL semantics 必须 verbatim record 进 V63 close DEC**)
```
