...
| `case_004_nrel_phase_vi_mrf` | Rotating machinery (MRF / sliding mesh) | 1 of 2 (no revision needed) | Tier-1 NREL Phase VI / NREL TP-500-29955 | D1 (0.30 mm gap nacelle↔cover) + D8 (0.75 mm thin yaw shim) | `methodology/kickoff/case_004_nrel_phase_vi_mrf.md` | 2026-05-07 evening | **DEFERRED** — drafted alongside case_003; user explicitly chose to draft case_004 ahead of case_003 actually running. Both queued for whenever sub-session resources free up. Order of execution flexible (both root-of-numerics-class, no cross-inheritance) |
| `case_005_rae_m2129_sduct` | Internal compressible subsonic-transonic diffuser | 1 of 2 (no revision needed) | Tier-1 NASA Glenn RAE M2129 (T1.I1; URL HTTP 500 transient) | D1 (0.35 mm flange gap) + D2 (102,400-tri over-dense throat liner) | `methodology/kickoff/case_005_rae_m2129_sduct.md` | 2026-05-08 | **DEFERRED** — single-fire sequence, dispatched per user decision. **Notable**: first case to exercise LANDED advisor (D2 → A3 geometry_surgery). 3rd consecutive case to surface A2-pending (compounded evidence). First compressible case for project (new BC writer + thermo writer + DC60 post-processor required) |
