...
`thermo_dict`, etc.) from on-disk OpenFOAM case directories.

v0.1 + V61-212 ships TWO extractors:
...
"Out of scope" + DEC-V61-213 / -214 DRAFTs) — adding to this package
later is additive.
...
__all__ = ["extract_shm_dict", "extract_solver_block_snapshot"]
