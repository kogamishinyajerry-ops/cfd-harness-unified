...
| `nusselt_max` | 0.07 | `dec_v61_057_intake` | DEC-V61-057 intake §B.1 chose 7% based on extractor sensitivity at peak local Nu region |
| `u_max_centerline_v` | 0.05 | `dec_v61_057_intake` | DEC-V61-057 intake §B.2 chose 5% — interior-velocity peak is a tight independent cross-check |
| `v_max_centerline_h` | 0.05 | `dec_v61_057_intake` | DEC-V61-057 intake §B.2 same rationale |
| `psi_max_center` | 0.08 | `dec_v61_057_intake` | DEC-V61-057 intake §B.3 chose 8% — trapezoidal ∫ reconstruction noise floor |

Citation coverage: 5/5 = 100% (1 literature-anchored to de Vahl Davis 1983, 4 to internal DEC-V61-057 intake — internal decision but documented and traceable).
